...
import net.findsnow.mobsnplenty.common.block.*;
...
public class MNPBlocks {
    ...
    public static final DeferredBlock<Block> PURPLE_FLAURELLE = registerBlock("purple_flaurelle",
            () -> new FlowerBlock(MobEffects.WEAKNESS, 9.0F, BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_TULIP)));
    public static final DeferredBlock<Block> PURPLE_LUPINE = registerBlock("purple_lupine",
            () -> new TallFlowerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LILAC)));
    public static final DeferredBlock<Block> PINK_FLAURELLE = registerBlock("pink_flaurelle",
            () -> new FlowerBlock(MobEffects.WEAKNESS, 9.0F, BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_TULIP)));
    public static final DeferredBlock<Block> PINK_LUPINE = registerBlock("pink_lupine",
            () -> new TallFlowerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LILAC)));
    public static final DeferredBlock<Block> WHITE_FLAURELLE = registerBlock("white_flaurelle",
            () -> new FlowerBlock(MobEffects.WEAKNESS, 9.0F, BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_TULIP)));
    public static final DeferredBlock<Block> WHITE_LUPINE = registerBlock("white_lupine",
            () -> new TallFlowerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LILAC)));
	...
	public static final DeferredBlock<Block> VENUS_FLYTRAP = registerBlock("venus_flytrap",
			() -> new MNPVenusFlytrapBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SMALL_DRIPLEAF)));

	// MNP BE
	public static final DeferredBlock<Block> CHOMPER = registerBlock("chomper",
			() -> new MNPChomperBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CRAFTER)));
